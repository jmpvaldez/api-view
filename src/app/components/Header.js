        ...
        <nav className="bg-white  fixed w-full z-20 top-0 start-0 shadow-lg ">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <a href="/" className="flex items-center space-x-3 rtl:space-x-reverse">
                    <Image height={45} width={45} src={'/emblem.png'} alt="Flowbite Logo" priority />
                        <span className="self-center hidden md:block text-xl font-semibold font-sans whitespace-nowrap text-red-600">API DOCUMENTATION</span>
                </a>
